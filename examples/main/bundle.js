...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appContainer = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appComponent = __webpack_require__(191);
	...
	var _appReducers = __webpack_require__(221);
	...
	function mapStateToProps(state) {
		return {
			stacks: (0, _appReducers.getStacks)(state.mainAppReducers),
			flip: (0, _appReducers.getFlip)(state.mainAppReducers)
		};
	}
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_appComponent2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactReduxFlipper = __webpack_require__(192);

	var _FlipperManagerContainer = __webpack_require__(200);

	var _FlipperManagerContainer2 = _interopRequireDefault(_FlipperManagerContainer);
	...
	var AppComponent = function (_React$Component) {
	  ...
	  function AppComponent(props) {
	    ...
	    _this.props.appActions.loadStacks([{
	      side: _reactReduxFlipper.PageSideTypesEnum.MAIN,
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'span',
	          { onClick: this.props.appActions.flipApp },
	          'Flip'
	        ),
	        _react2.default.createElement(
	          'div',
	          { style: style },
	          _react2.default.createElement(
	            _FlipperManagerContainer2.default,
	            {
	              cardsActions: {},
	              width: width,
	              height: height,
	              ...
	              side: stack.side,
	              stackId: stack.id,
	              onOpenDone: function onOpenDone() {},
	              onCloseDone: function onCloseDone() {}
	            },
	            _react2.default.createElement(
	              _reactReduxFlipper.Front,
	              null,
	              _react2.default.createElement(
	                'div',
	                { style: frontStyle },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.stackFlippingReducers = exports.FlippingActionTypes = exports.PageSideTypesEnum = exports.Back = exports.Front = exports.Flipper = undefined;

	var _Flipper = __webpack_require__(193);

	var _Front = __webpack_require__(195);

	var _Back = __webpack_require__(196);

	var _pageSideTypesEnum = __webpack_require__(197);

	var PageSideTypesEnum = _interopRequireWildcard(_pageSideTypesEnum);

	var _flippingActionTypes = __webpack_require__(198);

	var FlippingActionTypes = _interopRequireWildcard(_flippingActionTypes);

	var _baseStackReducers = __webpack_require__(199);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	exports.Flipper = _Flipper.Flipper;
	exports.Front = _Front.Front;
	exports.Back = _Back.Back;
	exports.PageSideTypesEnum = PageSideTypesEnum;
	exports.FlippingActionTypes = FlippingActionTypes;
	exports.stackFlippingReducers = _baseStackReducers.stackFlippingReducers;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var propTypes = {
	  animationProgress: _react2.default.PropTypes.number,
	...
	var Flipper = exports.Flipper = function (_React$Component) {
	  _inherits(Flipper, _React$Component);

	  function Flipper() {
	    _classCallCheck(this, Flipper);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Flipper).apply(this, arguments));
	  }

	  _createClass(Flipper, [{
	    key: 'getStackContainerStyle',
	    value: function getStackContainerStyle(animationProgress) {
	      var rotate = animationProgress * 180;
	      return Object.assign({}, _styles.STACK_CONTAINER, {
	    ...
	    key: 'render',
	    value: function render() {
	      var stackContainerStyle = this.getStackContainerStyle(this.props.animationProgress);
	      return _react2.default.createElement(
	        'div',
	        { style: _styles.STACK_FLIPPER },
	        _react2.default.createElement(
	          'div',
...
/***/ function(module, exports) {
	...
	var FRONT_STYLE = exports.FRONT_STYLE = Object.assign({}, MAXIMIZED, FRONT_BACK, {
	  position: 'absolute',
	  transform: 'rotateY(0deg)',
	  overflow: 'hidden'
	});

	var BACK_STYLE = exports.BACK_STYLE = Object.assign({}, MAXIMIZED, FRONT_BACK, {
	  position: 'absolute',
	  transform: 'rotateY(180deg)'
	});

	var STACK_FLIPPER = exports.STACK_FLIPPER = Object.assign({}, MAXIMIZED, {
	  position: 'absolute',
	  perspective: '1000px'
	});

	var STACK_CONTAINER = exports.STACK_CONTAINER = Object.assign({}, MAXIMIZED, {
	  position: 'relative',
...
/***/ function(module, exports) {
	...
	var PREPARE_TO_MAIN = exports.PREPARE_TO_MAIN = 1;
	var GOING_TO_MAIN = exports.GOING_TO_MAIN = 2;
	var MAIN = exports.MAIN = 3;
	var PREPARE_TO_COVER = exports.PREPARE_TO_COVER = 4;
	var GOING_TO_COVER = exports.GOING_TO_COVER = 5;
	var COVER = exports.COVER = 6;
...
/***/ function(module, exports) {
	...
	var PREPARE_TO_MAIN = exports.PREPARE_TO_MAIN = 'PREPARE_TO_MAIN';
	var GOING_TO_MAIN = exports.GOING_TO_MAIN = 'GOING_TO_MAIN';
	var MAIN_SET_DONE = exports.MAIN_SET_DONE = 'MAIN_SET_DONE';
	var PREPARE_TO_COVER = exports.PREPARE_TO_COVER = 'PREPARE_TO_COVER';
	var GOING_TO_COVER = exports.GOING_TO_COVER = 'GOING_TO_COVER';
	var COVER_SET_DONE = exports.COVER_SET_DONE = 'COVER_SET_DONE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.stackFlippingReducers = stackFlippingReducers;
	exports.getStackPages = getStackPages;
	...
	function stackFlippingReducers() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? initialState : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case _flippingActionTypes.PREPARE_TO_MAIN:
	      return Object.assign({}, state, {
	        side: PageSideTypesEnum.PREPARE_TO_MAIN
	      });
	    case _flippingActionTypes.GOING_TO_MAIN:
	      return Object.assign({}, state, {
	        side: PageSideTypesEnum.GOING_TO_MAIN
	      });
	    case _flippingActionTypes.MAIN_SET_DONE:
	      return Object.assign({}, state, {
	        side: PageSideTypesEnum.MAIN
	      });
	    case _flippingActionTypes.PREPARE_TO_COVER:
	      return Object.assign({}, state, {
	        side: PageSideTypesEnum.PREPARE_TO_COVER
	      });
	    case _flippingActionTypes.GOING_TO_COVER:
	      return Object.assign({}, state, {
	        side: PageSideTypesEnum.GOING_TO_COVER
	      });
	    case _flippingActionTypes.COVER_SET_DONE:
	      return Object.assign({}, state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flippingActions = __webpack_require__(201);

	var flippingActions = _interopRequireWildcard(_flippingActions);

	var _FlipperManager = __webpack_require__(202);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	function mapDispatchToProps(dispatch) {
	  return {
	    flippingActions: (0, _redux.bindActionCreators)(flippingActions, dispatch)
	  };
	}

	exports.default = (0, _reactRedux.connect)(undefined, mapDispatchToProps)(_FlipperManager.FlipperManager);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.goToMain = goToMain;
	exports.goToCover = goToCover;
	exports.goingToMain = goingToMain;
	exports.goingToCover = goingToCover;
	exports.goToMainDone = goToMainDone;
	exports.goToCoverDone = goToCoverDone;

	var _reactReduxFlipper = __webpack_require__(192);

	function goToMain(stackId) {
	  return { type: _reactReduxFlipper.FlippingActionTypes.PREPARE_TO_MAIN, stackId: stackId };
	}

	function goToCover(stackId) {
	  return { type: _reactReduxFlipper.FlippingActionTypes.PREPARE_TO_COVER, stackId: stackId };
	}

	function goingToMain(stackId) {
	  return { type: _reactReduxFlipper.FlippingActionTypes.GOING_TO_MAIN, stackId: stackId };
	}

	function goingToCover(stackId) {
	  return { type: _reactReduxFlipper.FlippingActionTypes.GOING_TO_COVER, stackId: stackId };
	}

	function goToMainDone(stackId) {
	  return { type: _reactReduxFlipper.FlippingActionTypes.MAIN_SET_DONE, stackId: stackId };
	}

	function goToCoverDone(stackId) {
	  return { type: _reactReduxFlipper.FlippingActionTypes.COVER_SET_DONE, stackId: stackId };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.FlipperManager = undefined;
	...
	var _autobindDecorator = __webpack_require__(203);
	...
	var _visabilityStatuses = __webpack_require__(218);
	...
	var propTypes = {
	  stackId: _react2.default.PropTypes.any,
	  side: _react2.default.PropTypes.any,
	  children: _react2.default.PropTypes.any,
	  flippingActions: _react2.default.PropTypes.any,
	  onOpenDone: _react2.default.PropTypes.any,
	  onCloseDone: _react2.default.PropTypes.any
	};

	var defaultProps = {};

	var FlipperManager = exports.FlipperManager = (_class = function (_React$Component) {
	  _inherits(FlipperManager, _React$Component);

	  function FlipperManager() {
	    _classCallCheck(this, FlipperManager);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(FlipperManager).apply(this, arguments));
	  }

	  _createClass(FlipperManager, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      switch (nextProps.side) {
	        case _reactReduxFlipper.PageSideTypesEnum.PREPARE_TO_MAIN:
	          // case PageSideTypesEnum.GOING_TO_MAIN:
	          this.props.flippingActions.goingToMain(this.props.stackId);
	          return;
	        case _reactReduxFlipper.PageSideTypesEnum.PREPARE_TO_COVER:
	    ...
	    key: 'onFlippingTransitionEnd',
	    value: function onFlippingTransitionEnd() {
	      // e.stopPropagation();
	      switch (this.props.side) {
	        case _reactReduxFlipper.PageSideTypesEnum.GOING_TO_MAIN:
	          this.props.flippingActions.goToMainDone(this.props.stackId);
	          if (this.props.onOpenDone) {
	            this.props.onOpenDone();
	          }
	          return;
	        case _reactReduxFlipper.PageSideTypesEnum.GOING_TO_COVER:
	          ...
	          return;
	        default:
	          (0, _invariant2.default)(true, 'Property "this.props.side" is out of range.');
	          return;
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var motionStyle = {
	        rotateValue: (0, _reactMotion.spring)((0, _visabilityStatuses.isStackOpen)(this.props.side) ? 0 : 1, _reactMotion.presets.noWobble)
	      };
	      return _react2.default.createElement(
	        _reactMotion.Motion,
	        { style: motionStyle, onRest: this.onFlippingTransitionEnd },
	        function (motionProps) {
	          return _react2.default.createElement(
	            _reactReduxFlipper.Flipper,
	            { animationProgress: motionProps.rotateValue },
	...
	}(_react2.default.Component), (_applyDecoratedDescriptor(_class.prototype, 'onFlippingTransitionEnd', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'onFlippingTransitionEnd'), _class.prototype)), _class);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.isStackOpen = isStackOpen;
	...
	function isStackOpen(status) {
	  switch (status) {
	    case _reactReduxFlipper.PageSideTypesEnum.MAIN:
	    case _reactReduxFlipper.PageSideTypesEnum.GOING_TO_MAIN:
	    case _reactReduxFlipper.PageSideTypesEnum.PREPARE_TO_COVER:
	      return true;
	    case _reactReduxFlipper.PageSideTypesEnum.COVER:
	    case _reactReduxFlipper.PageSideTypesEnum.GOING_TO_COVER:
	    case _reactReduxFlipper.PageSideTypesEnum.PREPARE_TO_MAIN:
	      return false;
	    default:
	      (0, _invariant2.default)(true, 'Property "status" in "isStackOpen" function is out of range.');
	      return true;
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.loadStacks = exports.flipApp = undefined;

	var _appLabelKeys = __webpack_require__(220);

	var flipApp = exports.flipApp = function flipApp() {
		return {
			type: _appLabelKeys.FLIP_APP
		};
	};

	var loadStacks = exports.loadStacks = function loadStacks(stacks) {
		return {
			type: _appLabelKeys.LOAD_STACKS,
			stacks: stacks
		};
	};
...
/***/ function(module, exports) {
	...
	var FLIP_APP = exports.FLIP_APP = 'FLIP_APP';
	var LOAD_STACKS = exports.LOAD_STACKS = 'LOAD_STACKS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.mainAppReducers = mainAppReducers;
	...
	var initialState = {
		flip: _reactReduxFlipper.PageSideTypesEnum.MAIN,
		stacks: []
	};

	function mainAppReducers() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? initialState : arguments[0];
		var action = arguments[1];

		var stacks = void 0;
		switch (action.type) {
			case _appLabelKeys.FLIP_APP:
				return flipAllPages(state);
			case _appLabelKeys.LOAD_STACKS:
				return Object.assign({}, state, {
					stacks: action.stacks
				});
				return state;
			case _reactReduxFlipper.FlippingActionTypes.PREPARE_TO_MAIN:
			case _reactReduxFlipper.FlippingActionTypes.GOING_TO_MAIN:
			case _reactReduxFlipper.FlippingActionTypes.MAIN_SET_DONE:
			case _reactReduxFlipper.FlippingActionTypes.PREPARE_TO_COVER:
			case _reactReduxFlipper.FlippingActionTypes.GOING_TO_COVER:
			case _reactReduxFlipper.FlippingActionTypes.COVER_SET_DONE:
				stacks = state.stacks.map(function (stack) {
					return stack.id === action.stackId ? Object.assign({}, stack, (0, _reactReduxFlipper.stackFlippingReducers)(stack, action)) : stack;
				});
				return Object.assign({}, state, {
					stacks: stacks
				});
	...
	function flipAllPages(state) {
		var stacksKeys = Object.keys(state.stacks),
		    newStacks = [];

		var newFlip = void 0,
		    newStackTypeEvent = void 0;

		// TODO: 6 steps
		switch (state.flip) {
			case _reactReduxFlipper.PageSideTypesEnum.MAIN:
				newFlip = _reactReduxFlipper.PageSideTypesEnum.COVER;
				newStackTypeEvent = _reactReduxFlipper.FlippingActionTypes.PREPARE_TO_COVER;
				break;
			case _reactReduxFlipper.PageSideTypesEnum.COVER:
				newFlip = _reactReduxFlipper.PageSideTypesEnum.MAIN;
				newStackTypeEvent = _reactReduxFlipper.FlippingActionTypes.PREPARE_TO_MAIN;
				break;
			default:
		...
		stacksKeys.forEach(function (pageKey) {
			var page = state.stacks[pageKey];

			newStacks[pageKey] = (0, _reactReduxFlipper.stackFlippingReducers)(page, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore(initialState) {
		return (0, _redux.createStore)(_reducers2.default, initialState, window.devToolsExtension ? window.devToolsExtension() : undefined);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rootReducer = (0, _redux.combineReducers)({
		mainAppReducers: _appReducers.mainAppReducers
	});
